...
#      print(initial, target, self.__gyro_callback(), (self.__gyro_callback() - initial))
  ...
  def set_absolute_direction(self, target):
    ...
    self.rotate_gyroscope(theta, 30) 
  ...
  def goto(self, new_position: Position):
    ...
    self.run_using_gyroscope(dist, 50)
...
class Program():
  ...
  def execMain(self):    
    self.robot.calibrate_gyroscope(5000)
...
#    self.robot.test_lidar()
    ...
    self.robot.goto(Position(0, 300, None))
    self.robot.lidar_measure()
    self.robot.draw_points()
#    self.robot.test_lidar()
    script.wait(10000)
    
    self.robot.goto(Position(300, 300, None))
    self.robot.lidar_measure()
    self.robot.draw_points()
#    self.robot.test_lidar()
    
    self.robot.goto(Position(300, 0, None))
    self.robot.lidar_measure()
    self.robot.draw_points()
#    self.robot.test_lidar()
#    self.robot.goto(Position(0, 0, None))
